        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-teacher-primary/0 group-hover:bg-teacher-primary/20 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                      <div className="w-12 h-12 rounded-full bg-white/80 flex items-center justify-center">
                        <Icon
                          name="ZoomIn"
                          className="h-6 w-6 text-teacher-primary"
                        />
                      </div>
                    </div>
                  </div>
                  <CardContent className="py-4">
                    <h3 className="text-lg font-medium text-teacher-primary">
                      Наш дружный класс
                    </h3>
          ...
          <div className="mt-12 text-center">
            <p className="text-muted-foreground italic">
              ...
              В нашем классе мы создаём атмосферу, где каждый может проявить
              свои таланты!"
            </p>
          </div>
        </div>
